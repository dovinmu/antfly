...
The retrieval agent accepts `gemini`, `vertex`, `openai`, `openrouter`, `ollama`, and `antfly` as generator providers. Other values parse and then fail the request with a 400.
