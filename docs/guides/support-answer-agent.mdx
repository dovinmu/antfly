...
The generator here is Ollama on the same machine. Gemini, Vertex, OpenAI, OpenRouter, and Antfly Inference work the same way; the [Quickstart](/docs/guides/quickstart#rag-with-alternative-providers) shows each config.
