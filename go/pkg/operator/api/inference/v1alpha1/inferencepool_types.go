...
// InferencePoolPhase represents the phase of a InferencePool
type InferencePoolPhase string

const (
	InferencePoolPhasePending  InferencePoolPhase = "Pending"
	InferencePoolPhaseRunning  InferencePoolPhase = "Running"
	InferencePoolPhaseScaling  InferencePoolPhase = "Scaling"
	InferencePoolPhaseDegraded InferencePoolPhase = "Degraded"
)

// Condition type and reason constants for InferencePool and InferenceProxy status.
const (
...
type InferencePoolStatus struct {
	...
	// Endpoints lists the current Inference endpoints
