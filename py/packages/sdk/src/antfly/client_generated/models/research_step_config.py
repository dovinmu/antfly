...
T = TypeVar("T", bound="ResearchStepConfig")


@_attrs_define
class ResearchStepConfig:
    """Configuration for one research role. Generator and chain default to the top-level request values.

    Attributes:
        enabled (bool | Unset): Whether the step runs. Defaults vary by step.
        ...
        chain (list[ChainLink] | Unset): Chain of generators for this role.
        instructions (str | Unset): Additional role instructions. They cannot change authorized tables, filters, tools
            or budgets.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        research_step_config.additional_properties = d
        return research_step_config
