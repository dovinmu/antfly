...
if TYPE_CHECKING:
    ...
    from ..models.stateful_query_request_graph_searches import StatefulQueryRequestGraphSearches
...
T = TypeVar("T", bound="StatefulQueryRequest")


@_attrs_define
class StatefulQueryRequest:
    """Stateful Antfly query request. Canonical clients use graph_queries; deprecated graph_searches is retained only at
        ...
        Attributes:
            ...
            foreign_sources (QueryRequestForeignSources | Unset): Map of table name to foreign data source configuration for
                ...
                **Example - Join Antfly products with Postgres customers:**
                ...
                ```
            graph_searches (StatefulQueryRequestGraphSearches | Unset): Deprecated compatibility alias for the v0.2 graph
                query contract.
            ...
            expand_strategy (StatefulQueryRequestExpandStrategy | Unset): Deprecated compatibility behavior for
                `graph_searches`. Canonical
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        graph_searches: StatefulQueryRequestGraphSearches | Unset
        if isinstance(_graph_searches, Unset):
            graph_searches = UNSET
        else:
            graph_searches = StatefulQueryRequestGraphSearches.from_dict(_graph_searches)

        _expand_strategy = d.pop("expand_strategy", UNSET)
        expand_strategy: StatefulQueryRequestExpandStrategy | Unset
        ...
        stateful_query_request.additional_properties = d
        return stateful_query_request
