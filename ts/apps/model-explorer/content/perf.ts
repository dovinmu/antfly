...
const rawComparisonSamples: PerfSample[] = [
  ...
  },
  {
    ...
    caveat:
      "Historical observation; peer build, feature parity, and timing boundary were not fully reconciled.",
  },
  {
    metric: "tok_s",
    phase: "decode",
  ...
  },
  {
    ...
    caveat:
      "Historical observation with a different weight format and unresolved configuration parity.",
  },
];
...
export const comparisonSamples: PerfSample[] = rawComparisonSamples.map((sample) => ({
  ...
  caveat:
    sample.caveat ??
    "Historical planning-note observation; not a current benchmark or matched ranking.",
}));
...
export const bytesBreakdown: BytesBreakdownEntry[] = [
  {
    ...
    mbPerToken: 1858,
    share: 0.657,
    note: "gate/up/down across 42 layers — why pair-fusion and batched FFN matter most",
  },
  {
    label: "LM head (Q6_K)",
    mbPerToken: 550,
    share: 0.195,
    note: "the [2560 × 262144] vocab matvec — historical baseline tensor traffic",
  },
  { label: "attention (Q4_0)", mbPerToken: 330, share: 0.117, note: "QKV + output projections" },
  {
    ...
    mbPerToken: 86,
    share: 0.03,
    note: "historical baseline includes the 55 MB F16 per_layer_model_proj, before staging savings",
  },
...
export const journeyE2bAir: JourneyEntry[] = [
  {
    label: "branch start",
    value: 44.5,
    detail: "~44–46 tok/s at branch start (§12 retrospective)",
    landed: true,
  },
  {
    ...
    delta: "+9–12%",
    detail:
      "Historical M4-qualified route: encode frame N+1 from the device-resident token before waiting on N. Token-identical. E4B +5–8%.",
    landed: true,
  },
  {
    ...
    delta: "+4–5%",
    detail:
      "opt-in Q6_K→Q4_K candidate repack of the vocab matvec (full logits retain Q6_K) (52.5→54.3–55.2). The Q4_0 head variant was refuted — instant-EOT quality collapse.",
    landed: true,
  },
  {
...
export const refutedLevers = [
  ...
  {
    label: "MTP Metal-auto",
    note: "E2B 75.9 target-only vs 63.7 with BF16 draft at 64% acceptance — net slower on Metal, default-off (§14.1)",
  },
];
...
export const finalsM4Pro = [
  {
    ...
    llama: 108.47,
    pct: "74.4%",
    context: "§16.3 short 23+256; earlier §14.4 long-context 84.5 vs 104.2 (81.1%)",
  },
  {
    model: "E4B",
    antfly: 56.069,
    llama: 62.98,
    pct: "89.0%",
    context: "§16.3 short 23+256; earlier §14.4 long-context 53.6 vs 61.0 (87.9%)",
  },
];
...
export const splitGqaRetune = {
  ...
  detail:
    "E2B floor 512→192 tokens: +12.84% (71.5→80.7). E4B floor 512→32: +18.56% (47.3→56.1). M4 Pro.",
};
...
export const censusStory = {
  q8Anchor: {
    ...
    barriers: 422,
    plannedScopes: 36,
    label: "Q8_0 anchor census (METAL.md)",
  },
  q4Live: {
    encoders: 1,
    plannedScopes: 143,
    plannedBarriers: 0,
    label: "historical Q4_0 decode census",
  },
};
