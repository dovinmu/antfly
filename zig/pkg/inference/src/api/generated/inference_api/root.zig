...
pub const AudioContext = types.AudioContext;
...
pub const DictateRequest = types.DictateRequest;
pub const DictateResponse = types.DictateResponse;
pub const DictationEvent = types.DictationEvent;
pub const DictationSegment = types.DictationSegment;
pub const DictationStyle = types.DictationStyle;
pub const DictationTranscript = types.DictationTranscript;
pub const DictationWord = types.DictationWord;
...
pub const TranscriptionAudioAppend = types.TranscriptionAudioAppend;
pub const TranscriptionAudioFormat = types.TranscriptionAudioFormat;
pub const TranscriptionEvent = types.TranscriptionEvent;
pub const TranscriptionEventList = types.TranscriptionEventList;
pub const TranscriptionSession = types.TranscriptionSession;
pub const TranscriptionSessionDeleted = types.TranscriptionSessionDeleted;
pub const TranscriptionSessionRequest = types.TranscriptionSessionRequest;
pub const TranscriptionStreamMessage = types.TranscriptionStreamMessage;
