...
pub const finetune = struct {
    ...
    pub const gliner_boundary_native_trainer = @import("finetune/gliner/boundary_native_trainer.zig");
    pub const gliner_boundary_merge_job = @import("finetune/gliner/boundary_merge_job.zig");
